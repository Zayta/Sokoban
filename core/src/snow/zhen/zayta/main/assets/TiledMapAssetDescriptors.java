...
public class TiledMapAssetDescriptors {
    ...
    public static final AssetDescriptor<TextureAtlas> MAP_GENERATOR =
            new AssetDescriptor<TextureAtlas>("gameplay/experiment/maps/generated_map_tiles/generated_map_tiles.atlas", TextureAtlas.class);
