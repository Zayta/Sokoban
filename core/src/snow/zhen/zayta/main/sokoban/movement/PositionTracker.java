...
//        goalTracker.clear();
    ...
    public void updateGlobalTracker(ArrayList<snow.zhen.zayta.main.sokoban.entity.EntityBase> entities){
        for(snow.zhen.zayta.main.sokoban.entity.EntityBase entity:entities)
            updateGlobalTracker(entity, entity.getX(),entity.getY());
    }
    public void updateGlobalTracker(snow.zhen.zayta.main.sokoban.entity.EntityBase entity, float x, float y) {
