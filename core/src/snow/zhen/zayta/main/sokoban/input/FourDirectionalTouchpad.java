 ...
 * previously.
 * @author Josh Street */
public class FourDirectionalTouchpad extends Widget {
    ...
    public FourDirectionalTouchpad (float deadzoneRadius, Skin skin) {
        this(deadzoneRadius, skin.get(TouchpadStyle.class));
    }

    /** @param deadzoneRadius The distance in pixels from the center of the touchpad required for the knob to be moved. */
    public FourDirectionalTouchpad (float deadzoneRadius, Skin skin, String styleName) {
        this(deadzoneRadius, skin.get(styleName, TouchpadStyle.class));
    }

    /** @param deadzoneRadius The distance in pixels from the center of the touchpad required for the knob to be moved. */
    public FourDirectionalTouchpad (float deadzoneRadius, TouchpadStyle style) {
    ...
    /** The style for a {@link FourDirectionalTouchpad}.
     * @author Josh Street */
