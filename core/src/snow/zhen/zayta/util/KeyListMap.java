...
public class KeyListMap<K,V>{
    ...
    * */
    private snow.zhen.zayta.util.BiMap<K, ArrayList<V>> keyList = new snow.zhen.zayta.util.BiMap<K,ArrayList<V>>();
    private snow.zhen.zayta.util.BiMap<V,K> objKeys = new BiMap<V, K>();
