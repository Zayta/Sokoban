...
//    private float scaleWidthOfStatsViewportToViewport,scaleHeightOfStatsViewportToViewport;
    ...
    private snow.zhen.zayta.versions_unused.conquest.Territory territory;
...
//    private ShapeRenderer shapeRenderer;
    ...
    public void show() {
        ...
        viewport = new FitViewport(snow.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.CQ_WORLD_WIDTH, snow.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.CQ_WORLD_HEIGHT, camera);
...
//        scaleHeightOfStatsViewportToViewport = statsViewport.getWorldHeight()/viewport.getWorldHeight();
        ...
        debugCameraController.setStartPosition(snow.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.CQ_WORLD_CENTER_X, SizeManager.CQ_WORLD_CENTER_Y);
...
//        debugStatsCameraController.setStartPosition(statsViewport.getWorldWidth()/2,statsViewport.getWorldHeight()/2);
        ...
        //game manager
        territory = new snow.zhen.zayta.versions_unused.conquest.Territory(viewport,batch,nur.getConquestAtlas());
