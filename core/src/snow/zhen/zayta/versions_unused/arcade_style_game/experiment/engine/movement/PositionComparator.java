...
public class PositionComparator implements Comparator<Entity> {
    ...
    public int compare(Entity entity1, Entity entity2) {
        VelocityComponent velocityComponent1 = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.MOVEMENT.get(entity1);
        if(velocityComponent1==null)
            return 1;
        VelocityComponent velocityComponent2 = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.MOVEMENT.get(entity2);
        if(velocityComponent2==null)
            return -1;

        snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.Direction direction1 = velocityComponent1.getDirection();
        Direction direction2 = velocityComponent2.getDirection();
        if(direction1!=direction2){
            return direction1.ordinal()-direction2.ordinal();
        }
        Position position1 = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.POSITION.get(entity1);
