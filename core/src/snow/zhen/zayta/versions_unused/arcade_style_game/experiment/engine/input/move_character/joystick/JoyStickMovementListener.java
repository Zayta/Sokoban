package snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.input.move_character.joystick;
...
public class JoyStickMovementListener extends ChangeListener {
    ...
    private final static Family PLAYABLE_CHARACTERS = Family.all(
            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.component.VelocityComponent.class, PlayerTag.class
    ).get();
    ...
    /*changes all playable character's directoins*/
    private void updateAllPlayableCharacters(snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.Direction direction){
