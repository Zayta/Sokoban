...
public class GameFitViewport extends FitViewport {
    ...
    private void landscapeView(int screenWidth, int screenHeight, boolean centerCamera){
        ...
        setScreenBounds((gameWidth - viewportWidth) / 2+ (int)(SizeManager.CONTROLLER_DIAMETER*screenWidth/ snow.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WIDTH),(screenHeight - viewportHeight) / 2, viewportWidth, viewportHeight);
        apply(centerCamera);
    }
//
//    @Override
