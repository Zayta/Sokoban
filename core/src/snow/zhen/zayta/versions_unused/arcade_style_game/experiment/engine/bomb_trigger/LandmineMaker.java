package snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.bomb_trigger;
...
import snow.zhen.zayta.versions_unused.game_mechanics.collision_mechanics.template_for_collision_system.CollisionSystemTemplate;
...
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveHolderComponent;
...
public class LandmineMaker extends ClickListener {
    ...
    private static final Family LANDMINERS = Family.all(
            PlayerTag.class,
            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveHolderComponent.class,
    ...
    private void plantLandMine(PooledEngine engine, TextureRegion landMineTextureRegion) {
        ImmutableArray<Entity> landMiners = engine.getEntitiesFor(LANDMINERS);

        for(Entity landMiner: landMiners) {
            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.component.Position position = landMiner.getComponent(Position.class);
            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveHolderComponent landMinerStrength = landMiner.getComponent(ExplosiveHolderComponent.class);

            Entity landmine = engine.createEntity();
            /*Landmine basic components*/
            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveComponent explosiveComponent = engine.createComponent(snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveComponent.class);
            landmine.add(explosiveComponent);


            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.TextureComponent landMineImg = engine.createComponent(TextureComponent.class);
...
//            ParticleEmitter.Particle todo check out this class from libgdx
            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.particle.ParticleAnimationComponent particleAnimationComponent = engine.createComponent(ParticleAnimationComponent.class);
            particleAnimationComponent.init(landMineImg.getRegion(),8,5);
            landmine.add(particleAnimationComponent);

            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveComponent landMinePower = engine.createComponent(ExplosiveComponent.class);
