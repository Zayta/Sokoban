package snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.monsters;
...
//                        currentFighters.put(nighter,monster);
    ...
    private boolean checkCollisionBetween(Entity nighter, Entity monster)
    {
        ...
        RectangularBoundsComponent obstacleBounds = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.RECTANGULAR_BOUNDS.get(monster);
...
//    }
    ...
    private void collideEvent(Entity nighter, Entity monster) {
        HealthComponent nighterHp = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.HEALTH.get(nighter);
