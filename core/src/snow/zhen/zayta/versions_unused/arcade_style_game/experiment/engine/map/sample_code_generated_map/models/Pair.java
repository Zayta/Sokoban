...
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.MapTools;
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.World;

public class Pair {
	private static snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.World world;
	...
	public static void setWorld(snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.World w) {
		world = w;
	}
...
//	}
	...
	public boolean isBorder() {
		Pair[] neighbours = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.MapTools.getFullNeighbors(this, world);
