package snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.noise;
...
public class SimplexNoise implements MapNoiseGenerator{
    ...
    snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.noise.SimplexNoise_octave[] octaves;
    float[] frequencys;
    float[] amplitudes;
    ...
    public SimplexNoise(int width, int height, float[] frequencys, float[] amplitudes){
        ...
        octaves=new snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.noise.SimplexNoise_octave[numberOfOctaves];
