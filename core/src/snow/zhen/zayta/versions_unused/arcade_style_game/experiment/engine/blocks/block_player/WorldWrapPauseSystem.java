...
//        this.viewport = viewport;
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        WorldWrapComponent worldWrapComponent = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.WORLD_WRAP.get(entity);
        ...
        MovementLimitationComponent movementLimitationComponent =
                snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.MOVEMENT_LIMITATION.get(entity);
