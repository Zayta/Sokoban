...
public class LanternColorSwitchFlareSystem extends IteratingSystem implements Pool.Poolable {
    ...
    {
        super(Family.all(
                snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.ColorComponent.class,
                PositionTrackerComponent.class,
                RectangularBoundsComponent.class,
                HealthComponent.class
        ).one(NPCTag.class, NighterTag.class).exclude(snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.lanterns.LanternTag.class).get());
//        super(game,engine);
//        addMission();
        this.engine = engine;
...
//                        currentFighters.put(lantern,entity);
    ...
    {
        RectangularBoundsComponent playerBounds = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.RECTANGULAR_BOUNDS.get(entity);
        RectangularBoundsComponent obstacleBounds = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.RECTANGULAR_BOUNDS.get(lantern);
...
//    }
    ...
    private void collideEvent(Entity entity, Entity lantern) {
        ...
        snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.ColorComponent entityColor = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.COLOR.get(entity);

        ColorComponent lanternColor = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.COLOR.get(lantern);
//        Mappers.COLOR.get(lantern).setColor(Mappers.COLOR.get(entity).getColor());
        snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.lanterns.LanternTag lanternTag = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.LANTERN.get(lantern);
        ...
        if(lanternTag.getState()== snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.lanterns.LanternTag.State.DORMANT){
            if(lanternColor.getColor().equals(entityColor.getColor())){
                lanternTag.setState(snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.lanterns.LanternTag.State.FLARE);
...
//                particleAnimationComponent.init(RegionNames.FIRE_BLOB_PREFLARE,6,1);
        ...
        else if(lanternTag.getState()== snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.lanterns.LanternTag.State.FLARE){
            if(lanternColor.getColor().equals(entityColor.getColor())){
            ...
            {
                snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.HEALTH.get(entity).decrement(Mappers.EXPLOSIVE.get(lantern).getPower());
            }
        }
