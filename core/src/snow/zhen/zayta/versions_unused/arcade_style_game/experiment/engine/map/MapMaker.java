...
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.TiledMapGenerator;
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.MapType;
...
//        Arrangements.initAvailableKeys((int)mapBounds.width,(int)mapBounds.height);
    ...
    private void setMapBounds(TiledMap tiledMap){
        ...
        setMapBoundmaxY(mapProperties.get("height", Integer.class)- snow.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjHeight);
        Arrangements.initAvailableKeys(mapBounds.width,mapBounds.height);
    }
