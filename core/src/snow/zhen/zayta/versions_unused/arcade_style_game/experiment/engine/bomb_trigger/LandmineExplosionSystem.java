...
public class LandmineExplosionSystem extends EntitySystem {
    ...
    public LandmineExplosionSystem(){
        ...
        MONSTERS = Family.all(
                ...
                snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.HealthComponent.class,
    ...
    {
        snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.component.RectangularBoundsComponent playerBounds = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.RECTANGULAR_BOUNDS.get(entity);
        RectangularBoundsComponent obstacleBounds = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.RECTANGULAR_BOUNDS.get(obstacle);
...
//        //////log.debug("mosnter collided w landmine");
        HealthComponent monsterHp = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.HEALTH.get(monster);
