...
//        Mappers.COLOR.get(lantern).setColor(Mappers.COLOR.get(entity).getColor());
        LanternTag lanternTag = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.LANTERN.get(lantern);
//
...
//                //log.debug("state should be set to flare n vel component removed");
                ...
                snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.particle.ParticleAnimationComponent particleAnimationComponent = engine.createComponent(snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.particle.ParticleAnimationComponent.class);
