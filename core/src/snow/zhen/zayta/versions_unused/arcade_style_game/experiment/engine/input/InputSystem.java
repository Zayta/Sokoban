package snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.input;
...
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.input.move_character.FlingController;
import snow.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager;
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.bomb_trigger.LandmineMaker;
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.input.move_character.KeyboardController;
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.input.move_character.joystick.JoyStickMovementController;
import snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.input.move_character.joystick.JoyStickMovementListener;
...
//    }
    ...
    private JoyStickMovementController joyStickMovementController(Skin skin){
        float backgroundDiameter = snow.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.CONTROLLER_DIAMETER*0.9f;
