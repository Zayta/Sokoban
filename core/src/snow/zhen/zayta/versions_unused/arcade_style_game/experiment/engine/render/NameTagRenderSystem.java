...
public class NameTagRenderSystem extends IteratingSystem {
    ...
    private static final Family FAMILY = Family.all(
            ...
            snow.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.NameTag.class
    ).get();
    ...
    public NameTagRenderSystem(Viewport viewport, SpriteBatch batch)
    {
        ...
        float scaleY = SizeManager.WAKE_WORLD_HEIGHT/ snow.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.HEIGHT;
        float fontScale = 2;
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        RectangularBoundsComponent bounds = snow.zhen.zayta.versions_unused.arcade_style_game.experiment.common.Mappers.RECTANGULAR_BOUNDS.get(entity);
