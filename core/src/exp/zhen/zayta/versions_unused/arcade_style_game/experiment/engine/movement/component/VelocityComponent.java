...
import exp.zhen.zayta.versions_unused.arcade_style_game.config.SpeedManager;
...
public class VelocityComponent implements Component, Pool.Poolable {
    ...
    private exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.Direction prevDirection = exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.Direction.none;
    private float xSpeed = exp.zhen.zayta.versions_unused.arcade_style_game.config.SpeedManager.DEFAULT_SPEED, ySpeed = SpeedManager.DEFAULT_SPEED;

    @Override
    public void reset() {
        direction = exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.Direction.none;
    }
    public void setDirection(exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.Direction direction){
        if(direction!= exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.Direction.none)
