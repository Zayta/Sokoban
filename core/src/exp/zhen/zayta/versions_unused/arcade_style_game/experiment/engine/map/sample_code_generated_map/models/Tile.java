package exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models;
...
public class Tile {	
	...
	Array<exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.TileSprite> sprites = new Array<exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.TileSprite>();
	...
	public Tile (exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.Pair pair) {
		makeCorners(pair);
		makeEdges(pair);
	}

	private void makeCorners(exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.Pair pair) {
	...
	private void makeEdges(exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.Pair pair) {
		// Build a hashmap of base -> edges
	...
	private HashMap<Integer, Integer> buildNeighborHashMap(exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.Pair pair,
                                                           exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.Pair[] neighbors) {
		HashMap<Integer, Integer> res = new HashMap<Integer, Integer>();

		int i = 0;
		for (exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.Pair p : neighbors) {
	...
	private void cornerHashMapToSprites(HashMap<Integer, Integer> tmp) {
		while (!tmp.isEmpty()) {
			...
			exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.TileSprite s = new exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.models.TileSprite(v);
