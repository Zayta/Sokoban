package exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator;
...
public class TiledMapGenerator {
    ...
    public TiledMap generateWorld(exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.MapType mapType){
        ...
        if(mapType!= exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.MapType.NONE)
...
//        boolean [][] landOrWater = getLandOrWaterUnits(worldWidth,worldHeight);//true = land
    ...
    private TiledMapTileLayer collisionLayer(){
        ...
        collisionLayer.setName(exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.MapMaker.collisionLayer);
