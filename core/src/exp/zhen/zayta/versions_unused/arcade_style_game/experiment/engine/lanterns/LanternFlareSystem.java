...
//                //log.debug("state should be set to flare n vel component removed");
                ...
                exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.particle.ParticleAnimationComponent particleAnimationComponent = engine.createComponent(exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.particle.ParticleAnimationComponent.class);
