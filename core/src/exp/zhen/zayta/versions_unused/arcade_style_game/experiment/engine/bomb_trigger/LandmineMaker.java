...
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveHolderComponent;
...
public class LandmineMaker extends ClickListener {
    ...
    private static final Family LANDMINERS = Family.all(
            PlayerTag.class,
            exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveHolderComponent.class,
    ...
    private void plantLandMine(PooledEngine engine, TextureRegion landMineTextureRegion) {
        ...
        for(Entity landMiner: landMiners) {
            exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.component.Position position = landMiner.getComponent(Position.class);
            exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveHolderComponent landMinerStrength = landMiner.getComponent(ExplosiveHolderComponent.class);

            Entity landmine = engine.createEntity();
            /*Landmine basic components*/
            exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveComponent explosiveComponent = engine.createComponent(exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveComponent.class);
            landmine.add(explosiveComponent);


            exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.TextureComponent landMineImg = engine.createComponent(TextureComponent.class);
...
//            ParticleEmitter.Particle todo check out this class from libgdx
            exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.particle.ParticleAnimationComponent particleAnimationComponent = engine.createComponent(ParticleAnimationComponent.class);
            particleAnimationComponent.init(landMineImg.getRegion(),8,5);
            landmine.add(particleAnimationComponent);

            exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.properties.explosion.ExplosiveComponent landMinePower = engine.createComponent(ExplosiveComponent.class);
