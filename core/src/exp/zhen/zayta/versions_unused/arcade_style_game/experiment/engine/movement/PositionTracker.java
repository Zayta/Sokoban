package exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement;
...
//    public static int n = (int)(GameConfig.WAKE_WORLD_WIDTH/GameConfig.maxObjWidth);
    ...
    public static int n = (int)((MapMaker.getMapBounds().getWidth())/ exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjWidth);
    ...
    {//todo this may cause error as i*maxObjHeight might be bigger than screenHeight
        int i = (int)(bottom/ exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjHeight),j = (int)(left/ exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjWidth)/*, n= mapWidth/maxObjWidth*/;
        return i*n+j;
    }
    /*returns bottom left corner of entity from its key*/
    public static Vector2 getPositionFromKey(int key){
        return new Vector2(
                (key%PositionTracker.n)* exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjWidth,
