...
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.TiledMapGenerator;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.tiled_map.map_generator.MapType;
...
//                    mapBoundmaxY = GameConfig.WAKE_WORLD_HEIGHT - GameConfig.maxObjHeight;
    private static Rectangle mapBounds = new Rectangle(0,0, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_WIDTH - exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjWidth, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_HEIGHT - exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjHeight);
...
//    private TiledMap [] tiledMaps;
    ...
    public MapMaker (AssetManager assetManager){
        ...
        initTiledMaps();
        initMapBounds(0,0, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_WIDTH - exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjWidth, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_HEIGHT - exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjHeight);
    }
...
//        Arrangements.initAvailableKeys((int)mapBounds.width,(int)mapBounds.height);
    ...
    private void setMapBounds(TiledMap tiledMap){
        ...
        setMapBoundmaxX(mapProperties.get("width", Integer.class)- exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.maxObjWidth);
