package exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map;
...
public class MapTools {
     ...
     *
     */
    public static Pair[] getCornerNeighbours(Pair pair, exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.World world) {
        for (int i = 0; i < 4; i++){
     ...
     *
     */
    public static Pair[] getEdgeNeighbours(Pair pair, exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.World world) {
        for (int i = 0; i < 4; i++){
    ...
    private static boolean withinBounds(int x, int y, exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.sample_code_generated_map.World world) {
