...
public class NameTagRenderSystem extends IteratingSystem {
    ...
    private static final Family FAMILY = Family.all(
            ...
            exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.components.NameTag.class
    ).get();
    ...
    public NameTagRenderSystem(Viewport viewport, SpriteBatch batch)
    {
        ...
        float scaleX = exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_WIDTH/ exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WIDTH;
        float scaleY = exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_HEIGHT/ SizeManager.HEIGHT;
        float fontScale = 2;
