package exp.zhen.zayta.versions_unused.arcade_style_game.experiment;
...
import exp.zhen.zayta.versions_unused.arcade_style_game.debug.debug_system.DebugCameraSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.debug.debug_system.DebugCircularBoundsRenderSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.debug.debug_system.DebugPositionTrackerSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.debug.debug_system.DebugRectangularBoundsRenderSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.debug.debug_system.GridRenderSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.blocks.BlockSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.blocks.block_player.MapBlockPauseSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.blocks.block_player.WorldWrapPauseSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.EntityLab;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.lanterns.LanternSpawnSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.monsters.MonsterAttacksNighterSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.PositionTracker;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.system.CameraUpdateSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.system.CircularBoundsSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.system.PositionTrackerUpdateSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.system.RectangularBoundsSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.EntityRenderSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.HudRenderSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.MonoColorEntityRenderSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.StatsRenderSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.TiledMapRenderSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.particle.ParticleAnimationSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.render.animation.sprite.SpriteAnimationSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.movable_items.MoveItemSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.movable_items.PickUpMovableItem;
import exp.zhen.zayta.versions_unused.arcade_style_game.movable_items.RemoveItemSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.movable_items.UpdatePushDirectionSystem;
...
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.input.InputSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.map.MapMaker;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.blocks.block_npc.MapBlockChangeDirectionSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.blocks.block_npc.IntervalChangeDirectionSystem;
import exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.system.MovementSystem;
...
//    private final Game game;
    ...
    private exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.entity.EntityLab entityLab;
...
//        this.game = game;
        ...
        exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.config(Gdx.graphics.getWidth(),Gdx.graphics.getHeight());
        /*Camera*/
        orthographicCamera = new OrthographicCamera();
        viewport = new FitViewport(exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_WIDTH, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_HEIGHT,orthographicCamera);

        hudViewport = new FitViewport(exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.HUD_WIDTH, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.HUD_HEIGHT);
...
//    }
    ...
    private void addDebugSystems(){
        ...
        engine.addSystem(new DebugCameraSystem(orthographicCamera, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_CENTER_X, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_CENTER_Y));
...
//            engine.addSystem(new DebugMovableBlocksSystem(viewport,game.getBatch()));
    ...
    public void resize(int width, int height) {
        exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.config(width,height);
        viewport.setWorldSize(exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_WIDTH, exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.WAKE_WORLD_HEIGHT);
        viewport.update(width,height,true);
        hudViewport.setWorldSize(exp.zhen.zayta.versions_unused.arcade_style_game.config.SizeManager.HUD_WIDTH, SizeManager.HUD_HEIGHT);
