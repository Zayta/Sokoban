...
public class LockerByColorSystem extends GameControllingSystem {
    ...
    private void initLockers(){
        ...
        for(int i =0; i<points.length; i++)
        {
            ...
            lockersKeyListMap.put(key,makeLocker(points[i].x,points[i].y, exp.zhen.zayta.versions_unused.arcade_style_game.movable_items.locker.LockerComponent.class/*,RegionNames.EMOTES_BLUE_EEK*/));
        }
//        //////log.debug("lockerKeyListMap: "+lockersKeyListMap);
    ...
    public void update(float deltaTime) {
        ...
        for(Entity lockerKey: lockerKeys) {
            ...
            int indexAbove = index+ exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.PositionTracker.n;
    ...
    {
        exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.component.RectangularBoundsComponent lockerBounds = Mappers.RECTANGULAR_BOUNDS.get(locker);
        exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.component.RectangularBoundsComponent lockerKeyBounds = Mappers.RECTANGULAR_BOUNDS.get(lockerKey);
