        ...
        for( int i = 0; i < items.size(); i++ )
            {
                ...
                if(entityDirection!=itemMovement.getDirection()||entityDirection== exp.zhen.zayta.versions_unused.arcade_style_game.experiment.engine.movement.Direction.none){
                    pocket.remove(item);
