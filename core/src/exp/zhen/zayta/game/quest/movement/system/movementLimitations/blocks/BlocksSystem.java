package exp.zhen.zayta.game.quest.movement.system.movementLimitations.blocks;
...
public class BlocksSystem extends EntitySystem {
    ...
    public BlocksSystem(TiledMapTileLayer collisionLayer)
    {
