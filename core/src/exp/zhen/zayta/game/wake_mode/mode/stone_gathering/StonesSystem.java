package exp.zhen.zayta.game.wake_mode.mode.stone_gathering;
...
import exp.zhen.zayta.game.wake_mode.entity.Arrangements;
...
import exp.zhen.zayta.game.wake_mode.collision.CollisionListener;
import exp.zhen.zayta.game.wake_mode.collision.GameControllingSystem;
...
public class StonesSystem extends GameControllingSystem implements CollisionListener {
    ...
    private void initStones(){
        ...
        for(int i =0; i<numStones; i++)
        {
            ...
            stonesBiMap.put(key,
                    WakeMode.manufacturer.makeEntityInPos(points[i].x,points[i].y,StoneTag.class,RegionNames.STONE));
