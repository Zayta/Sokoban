package exp.zhen.zayta.main.arcade_style_game.characters.utsubyo;
...
import exp.zhen.zayta.main.arcade_style_game.experiment.engine.entity.id_tags.MonsterTag;
...
public class Utsubyo {
    ...
    private KeyListMap <Monster, Stats> monsters;

    public Utsubyo(PooledEngine engine, TextureAtlas labAtlas){
        this.engine = engine;
        this.labAtlas = labAtlas;
        monsters = new KeyListMap<Monster, Stats>();
        initMonsters();
    }
