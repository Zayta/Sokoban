package exp.zhen.zayta.main.game.personality_engineering_lab.game_mechanics.mission.spirit_gathering;
...
import exp.zhen.zayta.main.game.personality_engineering_lab.entity.id_tags.NighterTag;
import exp.zhen.zayta.main.game.personality_engineering_lab.map.MapMaker;
import exp.zhen.zayta.main.game.personality_engineering_lab.game_mechanics.GameControllingSystem;
import exp.zhen.zayta.main.game.personality_engineering_lab.game_mechanics.collision_mechanics.template_for_collision_system.CollisionListener;
...
public class SpiritSystem extends GameControllingSystem implements CollisionListener {
    ...
    private static final Logger log = new Logger(exp.zhen.zayta.main.game.personality_engineering_lab.game_mechanics.mission.spirit_gathering.SpiritSystem.class.getName(),Logger.DEBUG);
