...
public class PickUpMovableItem extends EntitySystem  {
    ...
    public PickUpMovableItem(PooledEngine engine, Viewport viewport, TextureAtlas wakePlayAtlas){
...
//
//        EntityLab.addPositionComponents(engine,entity,x,y);
//
...
////        entity.add(pocketComponent);//todo this part makes everything laggy.
//
//        return entity;
//    }
