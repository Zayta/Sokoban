...
public class WPAssetDescriptors {
    ...
    public static final AssetDescriptor<TextureAtlas> MAP_GENERATOR =
            new AssetDescriptor<TextureAtlas>("gameplay/essence_lab/maps/generated_map_tiles/generated_map_tiles.atlas", TextureAtlas.class);
