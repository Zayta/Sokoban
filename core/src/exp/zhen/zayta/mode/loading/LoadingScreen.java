package exp.zhen.zayta.mode.loading;
...
//        log.debug("show");
        ...
        viewport = new FitViewport(SizeManager.HUD_WIDTH, SizeManager.HUD_HEIGHT, camera);
...
//        assetManager.load(AssetDescriptors.MAP_MEMLAB1);
