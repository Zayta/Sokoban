...
import exp.zhen.zayta.mode.quest.component.properties.battle.BattleComponent;
import exp.zhen.zayta.mode.quest.component.labels.UndeadTag;
...
public class UndeadXCivilianCollisionSystem extends GameControllingSystem implements CollisionListener {
    ...
    public void update(float deltaTime) {
        ...
        for(Entity nighter: nighters) {
            ...
            int keyAbove = key+(int)SizeManager.WORLD_WIDTH;
            int keyBelow = key-(int)SizeManager.WORLD_WIDTH;
